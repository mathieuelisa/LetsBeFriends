BEGIN;
insert into event (title, starting_date, ending_date, img_url, places_left, description, longitude, latitude, user_id) values ('Traveler On Stage', '2021-10-20 19:00:00', '2021-10-21 00:00:00', 'http://dummyimage.com/196x100.png/ff4444/ffffff', 10, "rendez-vous au café culturel pour discuter et organiser un voyage tout en apprenant une nouvelle langue autour d'un bon café'", -0.57918, 44.837789, 2);
insert into event (title, starting_date, ending_date, img_url, places_left, description, longitude, latitude, user_id) values ("Murder Party - Le meurtre d'Arthur Pendragon", '2021-11-05 09:00:00', '2021-11-05 17:00:00', 'http://dummyimage.com/186x100.png/ff4444/ffffff', 10, "Résolvez l'assassinat d Arthur Pendragon en parcourant les rues de Lyon tout en apprenant une langue étrangère", 4.835659,45.764043, 8);
insert into event (title, starting_date, ending_date, img_url, places_left, description, longitude, latitude, user_id) values ('Fête du cinéma japonais à aix-en-provence', '2021-10-10 14:00:00', '2021-10-10 22:30:00', 'http://dummyimage.com/103x100.png/5fa2dd/ffffff', 15, "Venez assister à la représentation de Your Name en version originale puis discuter du film en parlant japonais autour d un thé", 5.447427, 43.529742, 5);
insert into event (title, starting_date, ending_date, img_url, places_left, description, longitude, latitude, user_id) values ('Sunday Brunch', '2021-10-20 12:30:00', '2021-10-20 16:30:00', 'http://dummyimage.com/108x100.png/ff4444/ffffff', 30, 'Rendez vous au trocadéro pour bruncher et apprendre une nouvelle langue', 2.3522219, 48.856614, 7);
insert into event (title, starting_date, ending_date, img_url, places_left, description, longitude, latitude, user_id) values ('Week-end Nature', '2021-10-20 10:00:00', '2021-10-21 18:00:00', 'http://dummyimage.com/152x100.png/dddddd/000000', 10, 'Venez camper en foret pour un week-end et apprendre une nouvelle langue', -1.1672, 44.3945, 1);
insert into event (title, starting_date, ending_date, img_url, places_left, description, longitude, latitude, user_id) values ('Degustation de houmous', '2021-12-05 20:00:00', '2021-12-5 23:00:00', 'http://dummyimage.com/193x100.png/5fa2dd/ffffff', 8, 'Venez déguster du houmous et pratiquer les langues du magreb', 1.444209, 43.604652, 6);
insert into event (title, starting_date, ending_date, img_url, places_left, description, longitude, latitude, user_id) values ('Visite à La Rochelle', '2021-11-28 14:00:00', '2021-11-29 18:00:00', 'http://dummyimage.com/206x100.png/dddddd/000000', 10, 'Venez visiter La Rochelle et pratiquez une nouvelle langue entre amis ', -1.151139, 46.160329, 3 );
